            ...
            <section class="s2">
                <section class="featured">
                    ...
                    <section class="f-description">
                        <p>Hollow Knight is a 2D Metroidvania action-adventure game, that takes place in Hallownest, a fictional ancient kingdom. The player controls an insect-like, silent, and nameless knight while exploring the underground world. ... When the knight takes damage from an enemy or from the environment, a mask is reduced.</p>
                    </section>
